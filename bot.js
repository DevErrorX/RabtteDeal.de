...
app.get('/v.js', (req, res) => {
  ...
  res.send('(async function(){'
    ...
    + 'if(navigator.webdriver){err("Not supported");return}'
    + 'if(!navigator.languages||!navigator.languages.length){err("Not supported");return}'
    + 'if(/HeadlessChrome|PhantomJS|Selenium|Puppeteer/i.test(navigator.userAgent)){err("Not supported");return}'
